...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENGING_INTENT_ID=347;
        private static final int WATER_REMINDER_NOTIFICATION_ID=444;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID="reminder_notification_channel_id";
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context,
                WATER_REMINDER_PENGING_INTENT_ID,
                intent,
